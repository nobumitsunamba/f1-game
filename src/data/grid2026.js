...
export const TEAMS = [
  {
    ...
    drivers: [
      { name: 'ランド・ノリス', en: 'Lando Norris', num: 4, abbr: 'NOR' },
      { name: 'オスカー・ピアストリ', en: 'Oscar Piastri', num: 81, abbr: 'PIA' },
    ],
  },
  {
    ...
    drivers: [
      { name: 'シャルル・ルクレール', en: 'Charles Leclerc', num: 16, abbr: 'LEC' },
      { name: 'ルイス・ハミルトン', en: 'Lewis Hamilton', num: 44, abbr: 'HAM' },
    ],
  },
  {
    ...
    drivers: [
      { name: 'マックス・フェルスタッペン', en: 'Max Verstappen', num: 33, abbr: 'VER' },
      { name: 'アイザック・ハジャー', en: 'Isack Hadjar', num: 6, abbr: 'HAD' },
    ],
  },
  {
    ...
    drivers: [
      { name: 'ジョージ・ラッセル', en: 'George Russell', num: 63, abbr: 'RUS' },
      { name: 'アンドレア・キミ・アントネッリ', en: 'Kimi Antonelli', num: 12, abbr: 'ANT' },
    ],
  },
  {
    ...
    drivers: [
      { name: 'フェルナンド・アロンソ', en: 'Fernando Alonso', num: 14, abbr: 'ALO' },
      { name: 'ランス・ストロール', en: 'Lance Stroll', num: 18, abbr: 'STR' },
    ],
  },
  {
    ...
    drivers: [
      { name: 'ピエール・ガスリー', en: 'Pierre Gasly', num: 10, abbr: 'GAS' },
      { name: 'フランコ・コラピント', en: 'Franco Colapinto', num: 43, abbr: 'COL' },
    ],
  },
  {
    ...
    drivers: [
      { name: 'アレクサンダー・アルボン', en: 'Alexander Albon', num: 23, abbr: 'ALB' },
      { name: 'カルロス・サインツ', en: 'Carlos Sainz', num: 55, abbr: 'SAI' },
    ],
  },
  {
    ...
    drivers: [
      { name: 'リアム・ローソン', en: 'Liam Lawson', num: 30, abbr: 'LAW' },
      { name: 'アービッド・リンドブラッド', en: 'Arvid Lindblad', num: 41, abbr: 'LIN' },
    ],
  },
  {
    ...
    drivers: [
      { name: 'ニコ・ヒュルケンベルグ', en: 'Nico Hülkenberg', num: 27, abbr: 'HUL' },
      { name: 'ガブリエル・ボルトレート', en: 'Gabriel Bortoleto', num: 5, abbr: 'BOR' },
    ],
  },
  {
    ...
    drivers: [
      { name: 'エステバン・オコン', en: 'Esteban Ocon', num: 31, abbr: 'OCO' },
      { name: 'オリバー・ベアマン', en: 'Oliver Bearman', num: 87, abbr: 'BEA' },
    ],
  },
  {
    ...
    drivers: [
      { name: 'セルジオ・ペレス', en: 'Sergio Pérez', num: 11, abbr: 'PER' },
      { name: 'バルテリ・ボッタス', en: 'Valtteri Bottas', num: 77, abbr: 'BOT' },
    ],
  },
];
